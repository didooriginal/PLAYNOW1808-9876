...
export const templates = {
  ...
  boasVindasIptv: (dados: {
    ...
    texto: [
      `Ola, ${dados.nome}!`,
      "",
      "Seu plano de IPTV (PLAYPLUSNOW + Canais ao vivo) esta confirmado. Faltam 3 passos rapidos:",
      "",
      "1) Baixe o aplicativo no seu aparelho:",
      `   - iPhone / iPad: ${dados.linkIos}`,
      `   - Android (celular ou TV Box): ${dados.linkAndroid}`,
      `   - Smart TV: ${dados.instrucaoTv}`,
      "2) Ao abrir o aplicativo, localize o endereco MAC no canto inferior direito da tela.",
      `3) Envie esse MAC para nos pelo seu painel: ${dados.linkPainel}`,
      "",
      "O MAC tem o formato AA:BB:CC:DD:EE:FF. Assim que recebermos, liberamos os canais no seu aparelho e voce e avisado no painel.",
    ].join("\n"),
    html: layoutEmail({
      titulo: "Falta 1 passo para liberar seus canais",
      corpo: `
        <p>Ola, <strong>${dados.nome}</strong>!</p>
        <p>Seu plano <strong>PLAYPLUSNOW + Canais ao vivo</strong> esta confirmado. O IPTV e liberado pelo <strong>endereco MAC</strong> do seu aparelho, entao precisamos que voce faca isto:</p>
        <div style="background:rgba(255,255,255,0.05); padding:20px; border-radius:12px; margin:20px 0;">
          <p style="margin:0 0 12px; color:#ffffff;"><strong>1.</strong> Baixe o aplicativo no seu aparelho:</p>
          <p style="margin:0 0 8px 16px; color:#ffffff;">iPhone / iPad: <a href="${dados.linkIos}" style="color:#22d3ee;">baixar XCloud Mobile na App Store</a></p>
          <p style="margin:0 0 8px 16px; color:#ffffff;">Android (celular ou TV Box): <a href="${dados.linkAndroid}" style="color:#22d3ee;">baixar FUNPLAY na Play Store</a></p>
          <p style="margin:0 0 12px 16px; color:#ffffff;">Smart TV: ${dados.instrucaoTv}</p>
          <p style="margin:0 0 10px; color:#ffffff;"><strong>2.</strong> Abra o aplicativo e localize o <strong>endereco MAC no canto inferior direito da tela</strong>.</p>
          <p style="margin:0; color:#ffffff;"><strong>3.</strong> Envie esse MAC para nos no seu painel, na aba <strong>Ativar IPTV</strong>.</p>
        </div>
      ...
      `,
      botao: { texto: "Enviar meu endereco MAC", url: dados.linkPainel },
      rodape: "Nao conseguiu achar o MAC? Responda este e-mail ou abra um chamado no painel que a gente te guia.",
    }),
  }),
};
